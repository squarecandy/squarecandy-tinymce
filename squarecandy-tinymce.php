...
Description: An opinionated reconfigureation of the default wordpress TinyMCE settings.
Version:     1.0
Author:      Peter Wise
...
class squarecandy_tinymce_writing_setting {
    function squarecandy_tinymce_writing_setting( ) {
...
function make_mce_awesome($in) {
  ...
  if (!empty($sqcdy_theme_color1)) $custom_colors .= ',"'.$sqcdy_theme_color1.'","Branding Color 1"';
  if (!empty($sqcdy_theme_color2)) $custom_colors .= ',"'.$sqcdy_theme_color2.'","Branding Color 2"';
  if (!empty($sqcdy_theme_color3)) $custom_colors .= ',"'.$sqcdy_theme_color3.'","Branding Color 3"';
  if (!empty($sqcdy_theme_color4)) $custom_colors .= ',"'.$sqcdy_theme_color4.'","Branding Color 4"';
...
// make it compatible with ACF too
